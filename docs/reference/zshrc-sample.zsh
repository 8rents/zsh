...
# Exchanges the meanings of ‘+’ and ‘-’ when used with a number to specify a directory in the stack. `cd -3` goes back three directories in the cd stack. I do this because `cd -<n>` matches `git checkout @{-<n>}` better than `cd +<n>` does.
# https://zsh.sourceforge.io/Doc/Release/Options.html#Changing-Directories
setopt pushd_minus
...
# https://zsh.sourceforge.io/Doc/Release/Completion-System.html#Standard-Styles # https://github.com/marlonrichert/zsh-autocomplete/blob/cfc3fd9a75d0577aa9d65e35849f2d8c2719b873/Functions/Init/.autocomplete__config#L10C24-L10C69
...
# If [menu] is ‘true’ in the context of any of the tags defined for the current completion menu completion will be used.
...
# If [use-cache] is set, the completion caching layer is activated for any completions which use it
