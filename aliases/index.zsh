...
alias notes="cd $HOME/android/Notes && glow"
...
# Edit this file
alias aliases="nano $Z/aliases/index.zsh"


# Nano
# ----
alias n="nano"
alias nconf="nano $SETTINGS/nano/nanorc"


# Markdown
# --------
alias docs="glow $HOME/docs"
alias md="glow $HOME"
...
# tmux
# ----
alias tconf="nano $SETTINGS/tmux/tmux.conf"
